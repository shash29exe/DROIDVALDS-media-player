...
static const struct option long_options[] =
{
  ...
  { "pbmac1", no_argument, 0, CHAR_MAX + 16 },
  { "key-info", no_argument, 0, 'k' },
  { "p8-info", no_argument, 0, CHAR_MAX + 17 },
  { "to-rsa", no_argument, 0, CHAR_MAX + 18 },
  { "generate-privkey", no_argument, 0, 'p' },
  { "key-type", required_argument, 0, CHAR_MAX + 19 },
  { "key-format", required_argument, 0, CHAR_MAX + 20 },
  { "bits", required_argument, 0, CHAR_MAX + 21 },
  { "curve", required_argument, 0, CHAR_MAX + 22 },
  { "sec-param", required_argument, 0, CHAR_MAX + 23 },
  { "to-p8", no_argument, 0, CHAR_MAX + 24 },
  { "pkcs8", no_argument, 0, '8' },
  { "provable", no_argument, 0, CHAR_MAX + 25 },
  { "verify-provable-privkey", no_argument, 0, CHAR_MAX + 26 },
  { "seed", required_argument, 0, CHAR_MAX + 27 },
  { "crl-info", no_argument, 0, 'l' },
  { "generate-crl", no_argument, 0, CHAR_MAX + 28 },
  { "verify-crl", no_argument, 0, CHAR_MAX + 29 },
  { "verify-chain", no_argument, 0, 'e' },
  { "verify", no_argument, 0, CHAR_MAX + 30 },
  { "verify-hostname", required_argument, 0, CHAR_MAX + 31 },
  { "verify-email", required_argument, 0, CHAR_MAX + 32 },
  { "verify-purpose", required_argument, 0, CHAR_MAX + 33 },
  { "verify-allow-broken", no_argument, 0, CHAR_MAX + 34 },
  { "verify-profile", required_argument, 0, CHAR_MAX + 35 },
  { "p7-generate", no_argument, 0, CHAR_MAX + 36 },
  { "p7-sign", no_argument, 0, CHAR_MAX + 37 },
  { "p7-detached-sign", no_argument, 0, CHAR_MAX + 38 },
  { "p7-include-cert", no_argument, 0, CHAR_MAX + 39 },
  { "no-p7-include-cert", no_argument, 0, CHAR_MAX + 40 },
  { "p7-time", no_argument, 0, CHAR_MAX + 41 },
  { "no-p7-time", no_argument, 0, CHAR_MAX + 42 },
  { "p7-show-data", no_argument, 0, CHAR_MAX + 43 },
  { "no-p7-show-data", no_argument, 0, CHAR_MAX + 44 },
  { "p7-info", no_argument, 0, CHAR_MAX + 45 },
  { "p7-verify", no_argument, 0, CHAR_MAX + 46 },
  { "smime-to-p7", no_argument, 0, CHAR_MAX + 47 },
  { "generate-dh-params", no_argument, 0, CHAR_MAX + 48 },
  { "get-dh-params", no_argument, 0, CHAR_MAX + 49 },
  { "dh-info", no_argument, 0, CHAR_MAX + 50 },
  { "load-privkey", required_argument, 0, CHAR_MAX + 51 },
  { "load-pubkey", required_argument, 0, CHAR_MAX + 52 },
  { "load-request", required_argument, 0, CHAR_MAX + 53 },
  { "load-certificate", required_argument, 0, CHAR_MAX + 54 },
  { "load-ca-privkey", required_argument, 0, CHAR_MAX + 55 },
  { "load-ca-certificate", required_argument, 0, CHAR_MAX + 56 },
  { "load-crl", required_argument, 0, CHAR_MAX + 57 },
  { "load-data", required_argument, 0, CHAR_MAX + 58 },
  { "password", required_argument, 0, CHAR_MAX + 59 },
  { "null-password", no_argument, 0, CHAR_MAX + 60 },
  { "empty-password", no_argument, 0, CHAR_MAX + 61 },
  { "hex-numbers", no_argument, 0, CHAR_MAX + 62 },
  { "cprint", no_argument, 0, CHAR_MAX + 63 },
  { "rsa", no_argument, 0, CHAR_MAX + 64 },
  { "dsa", no_argument, 0, CHAR_MAX + 65 },
  { "ecc", no_argument, 0, CHAR_MAX + 66 },
  { "ecdsa", no_argument, 0, CHAR_MAX + 67 },
  { "hash", required_argument, 0, CHAR_MAX + 68 },
  { "salt-size", required_argument, 0, CHAR_MAX + 69 },
  { "label", required_argument, 0, CHAR_MAX + 70 },
  { "inder", no_argument, 0, CHAR_MAX + 71 },
  { "inraw", no_argument, 0, CHAR_MAX + 73 },
  { "no-inder", no_argument, 0, CHAR_MAX + 72 },
  { "outder", no_argument, 0, CHAR_MAX + 74 },
  { "outraw", no_argument, 0, CHAR_MAX + 76 },
  { "no-outder", no_argument, 0, CHAR_MAX + 75 },
  { "disable-quick-random", no_argument, 0, CHAR_MAX + 77 },
  { "template", required_argument, 0, CHAR_MAX + 78 },
  { "stdout-info", no_argument, 0, CHAR_MAX + 79 },
  { "ask-pass", no_argument, 0, CHAR_MAX + 80 },
  { "pkcs-cipher", required_argument, 0, CHAR_MAX + 81 },
  { "provider", required_argument, 0, CHAR_MAX + 82 },
  { "text", no_argument, 0, CHAR_MAX + 83 },
  { "no-text", no_argument, 0, CHAR_MAX + 84 },
  ...
  while ((opt = getopt_long (argc, argv, "!8Vcd:ehiklpqsuv:",
    ...
    switch (opt)
      ...
      case CHAR_MAX + 15: /* --to-p12 */
        ...
        break;
      case CHAR_MAX + 16: /* --pbmac1 */
        opts->present.pbmac1 = true;
        opts->enabled.pbmac1 = true;
        break;
      case 'k':
        opts->present.key_info = true;
        opts->enabled.key_info = true;
        break;
      case CHAR_MAX + 17: /* --p8-info */
        opts->present.p8_info = true;
        opts->enabled.p8_info = true;
        break;
      case CHAR_MAX + 18: /* --to-rsa */
