...
msgidxof (int code)
{
  ...
  : ((code >= 216) && (code <= 271)) ? (code - 2)
  : ((code >= 273) && (code <= 281)) ? (code - 3)
  : ((code >= 300) && (code <= 322)) ? (code - 21)
  : ((code >= 666) && (code <= 666)) ? (code - 364)
  : ((code >= 711) && (code <= 718)) ? (code - 408)
  : ((code >= 721) && (code <= 729)) ? (code - 410)
  : ((code >= 750) && (code <= 752)) ? (code - 430)
  : ((code >= 754) && (code <= 782)) ? (code - 431)
  : ((code >= 784) && (code <= 789)) ? (code - 432)
  : ((code >= 800) && (code <= 804)) ? (code - 442)
  : ((code >= 815) && (code <= 822)) ? (code - 452)
  : ((code >= 832) && (code <= 839)) ? (code - 461)
  : ((code >= 844) && (code <= 844)) ? (code - 465)
  : ((code >= 848) && (code <= 848)) ? (code - 468)
  : ((code >= 881) && (code <= 891)) ? (code - 500)
  : ((code >= 1024) && (code <= 1039)) ? (code - 632)
  : ((code >= 1500) && (code <= 1528)) ? (code - 1092)
  : ((code >= 1600) && (code <= 1601)) ? (code - 1163)
  : ((code >= 16381) && (code <= 16383)) ? (code - 15942)
  : 16384 - 15942);
}
